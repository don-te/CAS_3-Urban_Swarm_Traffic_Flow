...
class SimulationEngine:
    ...
    def finalize_iteration_stats(self):
        """Logs stats and runs evolutionary logic for the current completed iteration."""
        # 1. Archive Stats
        ...
        print(f"--- FINALISED ITERATION {self.current_iteration} ---")
